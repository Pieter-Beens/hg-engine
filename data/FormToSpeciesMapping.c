...
const u16 UNUSED FormToSpeciesMapping[] =
{
    ...
    [SPECIES_OMEGA_LARGE - SPECIES_MEGA_START] = SPECIES_OMEGA,
    ...
    [SPECIES_HUMBRED_GALARIAN - SPECIES_MEGA_START] = SPECIES_HUMBRED,
    ...
    [SPECIES_BAOBARAFFE_THERIAN - SPECIES_MEGA_START] = SPECIES_BAOBARAFFE,
    ...
    [SPECIES_XEROGRAV_SMALL - SPECIES_MEGA_START] = SPECIES_XEROGRAV,
    [SPECIES_XEROGRAV_LARGE - SPECIES_MEGA_START] = SPECIES_XEROGRAV,
    [SPECIES_XEROGRAV_SUPER - SPECIES_MEGA_START] = SPECIES_XEROGRAV,
    [SPECIES_BUTTERFAE_ACTIVE - SPECIES_MEGA_START] = SPECIES_BUTTERFAE,
    ...
    [SPECIES_NUGGLE_POM_POM - SPECIES_MEGA_START] = SPECIES_NUGGLE,
    [SPECIES_NUGGLE_PAU - SPECIES_MEGA_START] = SPECIES_NUGGLE,
    [SPECIES_NUGGLE_SENSU - SPECIES_MEGA_START] = SPECIES_NUGGLE,
    ...
    [SPECIES_GOROCHU_LOW_KEY - SPECIES_MEGA_START] = SPECIES_GOROCHU,
    ...
    [SPECIES_PINGWINNER_NOICE_FACE - SPECIES_MEGA_START] = SPECIES_PINGWINNER,
    [SPECIES_MORPEKO_HANGRY - SPECIES_MEGA_START] = SPECIES_MORPEKO,
    [SPECIES_ZACIAN_CROWNED - SPECIES_MEGA_START] = SPECIES_ZACIAN,
    [SPECIES_CHROMERA_CROWNED - SPECIES_MEGA_START] = SPECIES_CHROMERA,
    ...
    [SPECIES_EXEGGRATOR_THERIAN - SPECIES_MEGA_START] = SPECIES_EXEGGRATOR,
    ...
    [SPECIES_CHATINGALE_HISUIAN - SPECIES_MEGA_START] = SPECIES_CHATINGALE,
