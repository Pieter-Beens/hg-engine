...
#define SPECIES_KARPONITE_HISUIAN (SPECIES_HISUIAN_REGIONAL_START + 14)
...
#define SPECIES_KARPONITE_LORD (SPECIES_HISUIAN_REGIONAL_START + 20)

#define MAX_HISUIAN_REGIONAL_NUM (SPECIES_KARPONITE_LORD)
